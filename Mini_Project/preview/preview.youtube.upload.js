...
function uploadVideoCallback(response, videoURL) {
    fname.innerHTML = 'Attendance Upload Progress: ' + response + "%";
    ...
    if (response >= 100 || videoURL) {
        ...
        fname.innerHTML = 'Successfully Uploaded';
...
UploadVideo.prototype.uploadFile = function(fileName, file) {
    ...
    var metadata = {
        'name': '20178091' + '-' + currentdate.getHours() + ":"  + currentdate.getMinutes()+ "-" + fileName, // Filename at Google Drive
        'mimeType': 'video/webm', // mimeType at Google Drive
        'parents': ['1IA0MDm2H1h9wprpiCMh93FPdpXf0tv8l'], // Folder ID at Google Drive
    };
